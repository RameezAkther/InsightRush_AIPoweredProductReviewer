...
CREATE TABLE PricingDetails (
  ...
  `Date of Highest Price` VARCHAR(30) NOT NULL,
  `Lowest Price` VARCHAR(20) NOT NULL,
  `Date of Lowest Price` VARCHAR(30) NOT NULL,
  `Average Price` VARCHAR(20) NOT NULL,
  `Date of Average Price` VARCHAR(30) NOT NULL,
...
ALTER TABLE PricingDetails MODIFY COLUMN `Date of Highest Price` VARCHAR(100) NOT NULL, MODIFY COLUMN `Date of Lowest Price` VARCHAR(100) NOT NULL, MODIFY COLUMN `Date of Average Price` VARCHAR(100) NOT NULL;
